...
export const ESTADO_DESCRIPCION = {
  ...
  CITA_CONFIRMADA:    'Notaría confirmó — Asistir en la hora agendada',
 ...
 *   11:00 – 12:30  ó  13:30 – 16:45
 */
export function validarRangoHorario(hora) {
  ...
  return (mins >= 660 && mins <= 750) ||   // 11:00 (660) – 12:30 (750)
         (mins >= 810 && mins <= 1005)     // 13:30 (810) – 16:45 (1005)
}
