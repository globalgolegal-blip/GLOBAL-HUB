'use client'
// components/ContractList.jsx — ETAPA 1
// Único cambio: agregar PENDIENTE_JOTFORM y OBSERVADO_SISTEMA al objeto ORDEN.
import ContractCard from './ContractCard'

const ORDEN = {
  VENCIDO:            0,
  OBSERVADO:          1,
  OBSERVADO_SISTEMA:  1,  // [NUEVO] misma prioridad que OBSERVADO — requiere revisión Legal
  CONTRATO_OBSERVADO: 2,
  SOLICITADO:         2,
  PENDIENTE:          3,
  PENDIENTE_JOTFORM:  3,  // [NUEVO] misma prioridad que PENDIENTE — JotForm pendiente
  VALIDADO:           4,
  INGRESADO:          5,
}
