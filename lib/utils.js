...
export function derivarEstado(contrato) {
  ...
  // (Se retiró el paso intermedio PENDIENTE_JOTFORM; el archivado ahora va a Dropbox.)
  if (firma === 'SI') {
  ...
  // CONFORME → VALIDADO directamente (cubre el lapso hasta que el trigger pone P=SI).
  // Cualquier otro valor en col V = observación del sistema.
...
export function estadoParaVista(estado, contrato) {
  ...
  // PENDIENTE_JOTFORM → VALIDADO  (por compatibilidad; ya no se produce)
